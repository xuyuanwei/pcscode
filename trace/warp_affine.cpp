...
int main( int argc, char** argv )
{
    ...
    srcTri_perspective[0] = Point2f( 98, 337 );
    srcTri_perspective[1] = Point2f( 278,307 );
    srcTri_perspective[2] = Point2f( 98, 98  );
    srcTri_perspective[3] = Point2f( 306,69  );

    dstTri_perspective[0] = Point2f( 70, 366 );
    dstTri_perspective[1] = Point2f( 339,336 );
    dstTri_perspective[2] = Point2f( 128,125 );
    dstTri_perspective[3] = Point2f( 247,97  );
